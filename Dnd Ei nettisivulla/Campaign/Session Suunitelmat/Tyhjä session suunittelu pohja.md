...
_(Kirjoita tilanne, tunnelma, NPCjen puheita tai johdanto pelaajille)_

---

## Suunnitelma

- Päähahmojen tavoitteet:
- Sivutehtävät / sivupolut:
...
- **NPC nimi:**
    ...
    - Suunniteltu liike / teko sessiolle:
    - Äänenpainot / fiilis:
    - Tavoitteet pelaajien suuntaan:

_(Toista jokaiselle NPC:lle)_
